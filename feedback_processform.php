...
if (($_SERVER['REQUEST_METHOD'] == 'POST') && (!empty($_POST['action']))):
    ...
    // 定义记录文件路径和最大发送次数
$record_file = 'send_record_feedback.txt';
$max_send_count = 5;
...
if (isset($_POST['remark'])) {
	...
	if (!($formerrors)):
         ...
         $mail->Subject = 'Beijing Logic Meeting 2023, From '.$clientEmail.' -- Feedback';
		...
		if ($ip_record['count'] < $max_send_count ):	
         ...
         $mail->Subject = 'Your feedback is received-- Beijing Logic Meeting 2023 ';
         $mail->Body = "Thanks for supporting our meeting. If you have asked some questions, we will reply to you via email as soon as possible. \r\n".
		               "Hive a nice day. \r\n";
