					...
					<div id="navWrapper">
						...
						<div class="contentL">
							<ul class="nav movedx" data-movedx-mid="1">
								...
								<li class="navitem">
									<a href="javascript:;" target=""> <span data-title="More Information">More Information</span> </a>
                                                                                                                                    <ul class="subnav">
                                                                                                                                     <li>
...
<br/>
 ...
 <div> <label>Institute*</label></div><br/>
  <input type="text" name="institute" placeholder="Please enter your Institute" value="<?php if (isset($clientInstitute)) {echo $clientInstitute;} ?>"/>
